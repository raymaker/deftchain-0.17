Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://deftchain.org/bin/deftchain-core-0.11.0/>
...
For example, add the following to `deftchain.conf`:
...
related to the blockchain in the deftchain system: the raw blocks as received over 
...
For an example script see [deftchain-submittx](https://github.com/laanwj/deftchain-submittx).
...
- #5334 `cf87536` libdeftchainconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new deftchain-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add deftchain logo to about screen
...
- #5809 `46bfbe7` Add deftchain-cli man page
...
- #5849 `41259ca` contrib/init/deftchaind.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for deftchain-tx)
