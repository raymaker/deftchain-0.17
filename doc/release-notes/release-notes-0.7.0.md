Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/deftchain/files/Bitcoin/deftchain-0.7.0/

We recommend that everybody running prior versions of deftchaind/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/deftchain/deftchain/tarball/v0.7.0  # .tar.gz
  https://github.com/deftchain/deftchain/zipball/v0.7.0  # .zip
...
in your terminal, then install the deftchain-qt package:
  sudo apt-get install deftchain-qt
...
Core deftchain handling and blockchain database
...
* Ensure a changed deftchain unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for deftchain-qt.exe
* (Windows only): add meta-data to deftchain-qt.exe (e.g. description)
...
* Bash programmable completion for deftchaind(1)
