Bitcoin Core version 0.13.2 is now available from:
  ...
  <https://deftchain.org/bin/deftchain-core-0.13.2/>
...
- #8908 `4a974b2` Update deftchain-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow deftchain-tx to create v2 transactions (btcdrak)
