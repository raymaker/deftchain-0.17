Bitcoin Core version 0.10.4 is now available from:
  ...
  <https://deftchain.org/bin/deftchain-core-0.10.4/>
...
- #6953 `43c2789` Split deftchain-tx into its own package
- #6953 `dfe0d4d` Include deftchain-tx binary on Debian/Ubuntu
