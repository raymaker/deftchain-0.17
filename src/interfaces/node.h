...
#ifndef DEFTCHAIN_INTERFACES_NODE_H
#define DEFTCHAIN_INTERFACES_NODE_H
...
//! Top-level interface for a deftchain node (deftchaind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // DEFTCHAIN_INTERFACES_NODE_H
