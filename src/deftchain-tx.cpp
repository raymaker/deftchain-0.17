...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " deftchain-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  deftchain-tx [options] <hex-tx> [commands]  Update hex-encoded deftchain transaction\n" +
            "or:     deftchain-tx [options] -create [commands]   Create hex-encoded deftchain transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded deftchain transaction
