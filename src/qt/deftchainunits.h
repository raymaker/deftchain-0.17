...
#ifndef DEFTCHAIN_QT_DEFTCHAINUNITS_H
#define DEFTCHAIN_QT_DEFTCHAINUNITS_H
...
public:
    ...
    /** Bitcoin units.
      @note Source: https://en.deftchain.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
#endif // DEFTCHAIN_QT_DEFTCHAINUNITS_H
