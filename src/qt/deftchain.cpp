...
{
    return QCoreApplication::translate("deftchain-core", psz).toStdString();
}
...
static void initTranslations(QTranslator &qtTranslatorBase, QTranslator &qtTranslator, QTranslator &translatorBase, QTranslator &translator)
{
    ...
    // Load e.g. deftchain_de.qm (shortcut "de" needs to be defined in deftchain.qrc)
    if (translatorBase.load(lang, ":/translations/"))
        QApplication::installTranslator(&translatorBase);

    // Load e.g. deftchain_de_DE.qm (shortcut "de_DE" needs to be defined in deftchain.qrc)
...
void BitcoinApplication::initializeResult(bool success)
{
    ...
    if(success)
    {
        ...
        // deftchain: URIs or payment requests:
...
int main(int argc, char *argv[])
{
    ...
    Q_INIT_RESOURCE(deftchain);
    Q_INIT_RESOURCE(deftchain_locale);
    ...
    /// 6. Determine availability of data and blocks directory and parse deftchain.conf
    ...
    // deftchain: links repeatedly have their payment requests routed to this process:
