...
#include <qt/deftchainamountfield.h>
...
//
//     src/qt/test/test_deftchain-qt -platform xcb      # Linux
//     src/qt/test/test_deftchain-qt -platform windows  # Windows
//     src/qt/test/test_deftchain-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: deftchain:")) != -1);
