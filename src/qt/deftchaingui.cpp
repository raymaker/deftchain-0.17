...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and deftchain: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a deftchain: URI or payment request"));
