...
#ifndef DEFTCHAIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define DEFTCHAIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // DEFTCHAIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
