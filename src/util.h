 ...
 */
#ifndef DEFTCHAIN_UTIL_H
#define DEFTCHAIN_UTIL_H
...
extern const char * const DEFTCHAIN_CONF_FILENAME;
extern const char * const DEFTCHAIN_PID_FILENAME;
...
{
    std::string s = strprintf("deftchain-%s", name);
